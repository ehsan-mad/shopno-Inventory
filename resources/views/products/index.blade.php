...
<head>
    ...
    <title>Products - ShopNo Inventory</title>
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        <div class="flex-shrink-0 flex items-center">
                            <h1 class="text-xl font-bold text-gray-800">ShopNo Inventory</h1>
                        </div>
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            Showing
                            <span class="font-medium" id="currentPageStart">1</span>
                            to
                            <span class="font-medium" id="currentPageEnd">10</span>
                            of
